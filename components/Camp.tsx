      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            With care, dedication, and sustainable practices, we cultivate and harvest the freshest produce, export every bite is filled with flavor and health and wealth and herbs to soothe your immune systemssss jaba tupu ndio tunatumia.
          </p>
          <Image
            src='/quote.svg'
            alt='camp-2'
